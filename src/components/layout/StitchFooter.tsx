                ...
                <div className="flex flex-col md:flex-row justify-between gap-10 mb-16">
                    <div className="max-w-sm">
                        ...
                        <div className="flex gap-4">
                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors hover:scale-110 transform duration-200">
                            ...
                            <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors hover:scale-110 transform duration-200">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <li><Link href="/shop?sort=best_selling" className="hover:text-primary transition-colors">Best Sellers</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400">
                            <li><Link href="/about" className="hover:text-primary transition-colors">Help Center</Link></li>
                            <li><Link href="/legal" className="hover:text-primary transition-colors">Returns</Link></li>
                            <li><Link href="/legal" className="hover:text-primary transition-colors">Size Guide</Link></li>
