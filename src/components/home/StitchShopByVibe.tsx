            ...
            <section className="w-full pb-20">
                <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 h-auto md:h-[600px]">
                        <Link href="/shop?category=streetwear" className="group relative col-span-1 md:col-span-2 md:row-span-2 overflow-hidden rounded-2xl bg-gray-100 dark:bg-gray-800">
                            <div
                            ...
                            <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10">
                                ...
                                <div className="mt-4 inline-flex items-center gap-2 text-white font-bold hover:text-primary transition-colors">
                                    Explore Collection <span className="material-symbols-outlined">arrow_forward</span>
                                </div>
                            </div>
                        </Link>
                        <Link href="/shop?category=accessories" className="group relative col-span-1 overflow-hidden rounded-2xl bg-gray-100 dark:bg-gray-800 h-[250px] md:h-auto">
                            <div
                                className="h-full w-full bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
                        ...
                        <Link href="/shop?category=denim" className="group relative col-span-1 overflow-hidden rounded-2xl bg-gray-100 dark:bg-gray-800 h-[250px] md:h-auto">
                            <div
                                className="h-full w-full bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
